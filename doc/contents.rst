...
- A `PDF <../latex/wanda.pdf>`_ version of |wanda| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages::wanda:wanda>`__ wiki.
...
|wanda| is released under a Cecill-C License.
